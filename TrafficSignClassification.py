...
data_dir = './TrafficSignModelClassification'
train_path = './TrafficSignModelClassification/Train'
test_path = './TrafficSignModelClassification/Test'
...
test = pd.read_csv('./TrafficSignModelClassification/Test.csv')
